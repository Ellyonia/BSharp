        ...
        <li>
          ...
          <input type='text' name = 'bandName' id='bandName' placeholder="Band Name" required/>
  			...
  			<li>
  				...
  				<input type='text' name = 'phone' id='phone' pattern="[0-9-]{10,}" placeholder="Phone Number" oninvalid="setCustomValidity('Please enter only numbers or dashes')" onchange="try{setCustomValidity('')}catch(e){}" required/>
  			</li>
  		</ol>
