...
<html lang="en">
  ...
  <body>
    ...
    <div class="page">
        ...
        <ul>
            <li>
                <input type="text" placeholder="First Name" pattern = "^[A-Za-z-']*$" id="firstName" name = "firstName" oninvalid="setCustomValidity('Please eneter only Letters or these symbols: - or a single quote')" onchange="try{setCustomValidity('')}catch(e){}" required/>
                <input type="text" placeholder="Last Name" pattern = "^[A-Za-z-']*$" id="lastName" name = "lastName" oninvalid="setCustomValidity('Please eneter only Letters or these symbols: - or a single quote')" onchange="try{setCustomValidity('')}catch(e){}" required/>
            </li>
